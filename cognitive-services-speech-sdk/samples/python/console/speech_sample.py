...
try:
    ...
    print("""
    Importing the Speech SDK for Python failed.f
    Refer to
...
speech_key, service_region = "c10cba30b93c40c0944f608f82b527ba", "japaneast"
...
def speech_recognize_once_from_file_with_customized_model():
    ...
    speech_config.endpoint_id = "https://japaneast.api.cognitive.microsoft.com/"
